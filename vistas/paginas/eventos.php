...
<?php 
    ...
    $total_eventos = ControladorPagina::ctrContarEventos();
    $total_paginas =$total_eventos/$eventos_por_pagina;
    $total_paginas = ceil($total_paginas);
    $pagina_web = ControladorPagina::ctrMostrarPagina();

    if (!$_GET['pestana']) {
        header('Location:index.php?pagina=eventos&pestana=1');
    }

    $eventos_todos = ControladorPagina::ctrMostrarEventosConPaginacion($_GET['pestana'], $eventos_por_pagina)
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="title-box text-center">
                    <h4 class="title-heading">Eventos</h4>
                    <p class="title-desc text-muted mt-4">Los eventos aparecen del más reciente al más antiguo.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12 p-0 pr-lg-5 ">
                <?php foreach ($eventos_todos as $key => $value) { ?>
                <!-- Inicio Noticia -->
                <div class="row">
